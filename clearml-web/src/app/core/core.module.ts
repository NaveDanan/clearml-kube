...
const userPrefMetaFactory = (userPreferences: UserPreferences): MetaReducer[] => [
  ...
  (reducer: ActionReducer<any>) =>
    createUserPrefReducer('views', ['autoRefresh', 'logRefreshInterval', 'neverShowPopupAgain', 'redactedArguments', 'hideRedactedArguments', 'theme', 'hideEnterpriseFeatures'], [VIEW_PREFIX], userPreferences, reducer),
  localStorageReducer,
  (reducer: ActionReducer<any>) =>
