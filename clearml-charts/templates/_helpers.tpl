...
{{/*
Reference Name (runai worker)
*/}}
{{- define "runaiWorker.referenceName" -}}
{{- include "clearml.fullname" . }}-runai-worker
{{- end }}
...
app.kubernetes.io/name: {{ include "clearml.fullname" . }}
app.kubernetes.io/instance: {{ include "runaiWorker.referenceName" . }}
{{- end }}
...
{{- .Values.clearml.existingSecret | quote }}
{{- end }}
