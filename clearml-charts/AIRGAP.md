...
clearml/runai-worker:2026-07-19
...
```bash
docker load -i clearml-images-slim-2026-07-19.tar
```
...
docker tag clearml/runai-worker:2026-07-19 <registry>/clearml/runai-worker:2026-07-19
docker push <registry>/clearml/clearml:2026-06-24
docker push <registry>/clearml/runai-worker:2026-07-19
```
