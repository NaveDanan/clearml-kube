...
clearml/runai-worker:2026-07-23
...
```bash
docker load -i clearml-images-slim-2026-07-23.tar
```
...
docker tag clearml/runai-worker:2026-07-23 <registry>/clearml/runai-worker:2026-07-23
docker push <registry>/clearml/clearml:2026-06-24
docker push <registry>/clearml/runai-worker:2026-07-23
```
