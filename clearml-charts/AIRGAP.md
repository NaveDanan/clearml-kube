...
clearml/runai-worker:2026-07-16
...
```bash
docker load -i clearml-images-slim-2026-07-16.tar
```
...
docker tag clearml/runai-worker:2026-07-16 <registry>/clearml/runai-worker:2026-07-16
docker push <registry>/clearml/clearml:2026-06-24
docker push <registry>/clearml/runai-worker:2026-07-16
```
