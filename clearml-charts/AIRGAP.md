...
clearml/runai-worker:2026-07-15
...
```bash
docker load -i clearml-images-slim-2026-07-15.tar
```
...
docker tag clearml/runai-worker:2026-07-15 <registry>/clearml/runai-worker:2026-07-15
docker push <registry>/clearml/clearml:2026-06-24
docker push <registry>/clearml/runai-worker:2026-07-15
```
